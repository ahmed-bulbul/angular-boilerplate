(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["all-modules-all-modules-module"], {
    ...
    function Jg(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_login_services_login_services__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var _all_modules_all_modules_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      var SidebarComponent = /*#__PURE__*/function () {
        function SidebarComponent(router, ngZone, allModulesService, toastr, sanitizer, loginService) {
          var _this2 = this;
        ...
        _createClass(SidebarComponent, [{
          ...
          value: function ngOnInit() {
            var self = this; // this._getPermittedMenu();
          ...
          key: "_hardCodeMenuString",
          value: function _hardCodeMenuString() {
          ...
          key: "_generateMenuHTML",
          value: function _generateMenuHTML(menuData) {
            var menuHTML = '';
            menuHTML = this._menuNodeRenderRF(menuData, menuHTML, 0);
            return menuHTML;
          }
        }, {
          key: "_menuNodeRenderRF",
          value: function _menuNodeRenderRF(menuData, menuHTML, level) {
            for (var k in menuData) {
              var menuNode = menuData[k];
              console.log("menuNode..... key  : " + k);
              console.log("menuNode..... level: " + level);
              var description = menuNode.description;
              var iconHtml = menuNode.iconHtml ? menuNode.iconHtml : "las la-angle-double-right la-sm";
              var openUrl = menuNode.openUrl;
              var hasChild = menuNode.hasChild;
              ...
              if (hasChild) {
                ...
                if (iconHtml) menuHTML += "<i class=\"".concat(iconHtml, "\"></i>");
                menuHTML += "<span>".concat(description, "</span>");
                menuHTML += "<span class=\"menu-arrow\"></span>";
                menuHTML += "</a>"; // child render recursively

                menuHTML += "<ul style=\"display: none;\">";
                menuHTML = this._menuNodeRenderRF(menuNode.child, menuHTML, level + 1);
                menuHTML += "</ul>"; // post ............................................................

                menuHTML += "</li>"; // customize according to level if you want

                if (level == 0) {//
                } else if (level == 1) {//
                } else {// generic links render
                  }
              } else {
          ...
          key: "_renderSingleLinkHTML",
          value: function _renderSingleLinkHTML(level, description, openUrl, iconHtml) {
            // menuHTML += `<li><a class="routerlink" href="${openUrl}"> <span>${description}</span></a></li>`;
            var menuHTML = '';
            menuHTML += "<li>";
            menuHTML += "<a class=\"routerlink\" href=\"".concat(openUrl, "\">");
            menuHTML += "<i class=\"".concat(iconHtml, "\"></i>");
            menuHTML += "<span>".concat(description, "</span>");
            menuHTML += "</a>";
            menuHTML += "</li>"; // customize according to level if you want

            if (level == 0) {// override HTML
            } else if (level == 1) {// override HTML
            }

            return menuHTML;
          }
        }, {
          key: "_getPermittedMenu",
          value: function _getPermittedMenu() {
            // let apiURL = this.baseUrl + "/common/getAuthMenus";
            var token = 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJzdXBlci1hZG1pbiIsImlhdCI6MTY1ODU2Njk1OSwiZXhwIjoxNjU4NTg0OTU5fQ.xMLnfc15B8R7-4WJ1Vmn6fjlDeFEW_uVhEeoiuArIuU47r-ZWUvWT3Bv2qRM8M1sUJLFzWNcUYHMyGQ0pKv9hA'; //const apiURL = this.baseUrl + '/system/systemMenu/getMenuData';

            var apiURL = 'http://143.110.191.105:8080/pta-service/system/systemMenu/getMenuData'; //add Bearer token

            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_10__["HttpHeaders"]().set('Authorization', 'Bearer ' + token);
            var queryParams = {}; // this.loginService.sendGetRequest(apiURL, queryParams).subscribe((response: any) => {
            //   // append response
          ...
          key: "navigateRouterLink",
          value: function navigateRouterLink(event) {
            var _this3 = this;
            ...
            if (event.target instanceof HTMLAnchorElement || event.target instanceof HTMLSpanElement) {
              ...
              if (element.className === 'routerlink') {
                ...
                var route = element === null || element === void 0 ? void 0 : element.getAttribute('href');

                if (route) {
                  this.ngZone.run(function () {
                    _this3.router.navigate(["/".concat(route)]);
                  });
                }
              }
            }
      ...
      SidebarComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["Component"])({
        selector: 'app-sidebar',
        template: _raw_loader_sidebar_component_html__WEBPACK_IMPORTED_MODULE_1__["default"],
        styles: [_sidebar_component_css__WEBPACK_IMPORTED_MODULE_2__["default"]]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"], _angular_core__WEBPACK_IMPORTED_MODULE_5__["NgZone"], _all_modules_all_modules_service__WEBPACK_IMPORTED_MODULE_8__["AllModulesService"], ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_9__["DomSanitizer"], src_app_login_services_login_services__WEBPACK_IMPORTED_MODULE_4__["LoginService"]])], SidebarComponent);
      /***/
    },
    ...
    function Qlo(module, __webpack_exports__, __webpack_require__) {
      ...
      var _login_services_login_services__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      HeaderService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _login_services_login_services__WEBPACK_IMPORTED_MODULE_4__["LoginService"]])], HeaderService);
      /***/
    },
    ...
    function fECr(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_login_services_login_services__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! src/app/login/services/login.services */
      "z8ke");
      /* harmony import */
      ...
      var _security_service_localstorage_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../security/service/localstorage.service */
      "2w4D");
      /* harmony import */
      ...
      var HeaderComponent = /*#__PURE__*/function () {
        function HeaderComponent(headerService, router, loginService, localstorageService) {
          var _this4 = this;
        ...
        _createClass(HeaderComponent, [{
          ...
          value: function getCurrentUser() {
            var data = this.localstorageService.getUser();
          ...
          value: function logout() {
            ...
            this.localstorageService.logout(); //swal
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_header_service__WEBPACK_IMPORTED_MODULE_7__["HeaderService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], src_app_login_services_login_services__WEBPACK_IMPORTED_MODULE_3__["LoginService"], _security_service_localstorage_service__WEBPACK_IMPORTED_MODULE_8__["LocalstorageService"]])], HeaderComponent);
      /***/
    },
    ...
    function sO8(module, __webpack_exports__, __webpack_require__) {
      ...
      var _all_modules_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./all-modules.component */
      "RFuP");
