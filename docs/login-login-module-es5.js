(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    /***/
    function Wt6O(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function gEuR(module, __webpack_exports__, __webpack_require__) {
      ...
      var _security_service_localstorage_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var _model_login__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ../model/login */
      "Wt6O");
      /* harmony import */


      var _services_login_services__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(formBuilder, toastr, loginService, router, spinnerService, localStorageService) {
        ...
        _createClass(LoginComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this._initForm(); //myForm data assign to formData variable
          ...
          value: function login() {
            ...
            this.isLoading = true; //set time 30 seconds

            this.loginService.login(this.formData).subscribe(function (data) {
              if (data['status'] === true) {
                console.log(data['user']);

                _this2.setToken(data['accessToken'], data['user']); // this.loginService.loginStatusSubject.next(true);
                ...
                sweetalert2__WEBPACK_IMPORTED_MODULE_12___default.a.fire({
                  ...
                  _this2.router.navigate(['/dashboard/admin']);
                });
          ...
          key: "setToken",
          value: function setToken(token, user) {
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"], ngx_toastr__WEBPACK_IMPORTED_MODULE_8__["ToastrService"], _services_login_services__WEBPACK_IMPORTED_MODULE_11__["LoginService"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"], ngx_spinner__WEBPACK_IMPORTED_MODULE_7__["NgxSpinnerService"], _security_service_localstorage_service__WEBPACK_IMPORTED_MODULE_3__["LocalstorageService"]])], LoginComponent);
      /***/
    },
